...
public class menu {
    ...
    public static void isiData(Data data, Pesawat pesan, int menu) {
        Scanner scan = new Scanner(System.in);
    ...
    public static int diskon(){
        ...
        System.out.println("Ingin menggunakan diskon?");
        ...
        if (pilih.equalsIgnoreCase("ya")) {
            ...
            int pilihDiskon = scan.nextInt();
            //int pilihDiskon2 = Integer.parseInt(pilihDiskon);
                    
            diskon = discounts.get(pilihDiskon);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Apakah anda mau login? (ya/tidak)");
        String login = scan.nextLine();

        if (login.equalsIgnoreCase("ya")) {
            login();
            while (menu != 5) {
                ...
                switch (menu) {
                    case 1:
                        ...
                        System.out.print("1. Bandung \n2. Jakarta \n3. Bali \nMasukkan kota: ");
                        int kota2 = scan.nextInt();
                        ...
                        if (kota2 == 1) {
                            ...
                            System.out.print("1. West Point Hotel \n2. Harris Hotel \n3. Hotel Serela \nPilih hotel: ");
                            int pilihHotel2 = scan.nextInt();
                            ...
                            // int pilihHotel2 = Integer.parseInt(pilihHotel);
                            System.out.print("1. Hotel Mulia Senayan \n2. Hotel Indonesia Kempinski \n3. Topaz Residence \nPilih hotel: ");
                            int pilihHotel2 = scan.nextInt();
                            hotelName = hotel.namaHotel[pilihHotel2 - 1];
                            historyHotel.add(hotel.namaHotel[pilihHotel2-1]);
                        } else {
                            ...
                            // int pilihHotel2 = Integer.parseInt(pilihHotel);
                            System.out.print("1. Melia Purosani Yogyakarta \n2. Sheraton Mustika Yogyakarta \n3. The Alana Yogyakarta Hotel \nPilih hotel: ");
                            int pilihHotel2 = scan.nextInt();
                            hotelName = hotel.namaHotel[pilihHotel2 - 1];
                            historyHotel.add(hotel.namaHotel[pilihHotel2-1]);
                        }
                        ...
                        System.out.print("1. Standard Room \n2. Deluxe Room \n3. Presidential Suite \nPilih tipe kamar: ");
                        int tipeKamar2 = scan.nextInt();
                        ...
                        System.out.print("1. Single Bed \n2. Queen Size \n3. King Size \nPilih tipe kasur: ");
                        int tipeKasur2 = scan.nextInt();
                    ...
                    case 4:
                        ...
                        if(pilih2 == 1){
                            ...
                            if(historyHotel.isEmpty() && historyPesawat.isEmpty()) {
                                JOptionPane.showMessageDialog(null, "History pesanan kosong");
                            } else {
                                for(String datum : historyPesawat) {
                                    temp[i] = datum;
