...
public class Collections2_1122041_KatherinYuliana {
    ...
    public static void pinjam(Peminjaman peminjaman, Member member, Buku buku){
        ...
        if (members.containsKey(peminjaman.idMember) && books.contains(buku)) {
